...
export default function UserDropdown() {
  ...
  // State untuk menyimpan data user dan role
  ...
  useEffect(() => {
    ...
    if (storedUserData ) {
      ...
      setUser({
        ...
        username: parsedUser.username || "", // Gunakan username jika diperlukan
      });
  ...
  function logout() {
    // Hapus token dari localStorage (atau sessionStorage jika Anda menggunakannya)
    localStorage.removeItem('token');

    // Opsional: Hapus data pengguna lainnya jika ada
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm" id="name">
           {user.name || "User"} {/* Gunakan name dinamis */}
        </span>
        <svg
      ...
      >
        <div>
          <span className="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">
            {user.username || "Nama User"} {/* Gunakan name dinamis */}
          </span>
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
            {user.email || "email@example.com"} {/* Gunakan email dinamis */}
          </span>
        </div>
